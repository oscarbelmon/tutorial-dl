...
plt.tight_layout()
if save_plots:
    plt.savefig(os.path.join('images', 'img_enhance_tf_ae_train.png'))
else:
    plt.show()
...
autoencoder.summary()
plot_model(autoencoder, to_file=os.path.join('images', 'img_enhance_tf_ae.png'), show_shapes=True)
...
plt.tight_layout()
if save_plots:
    plt.savefig(os.path.join('images', 'img_enhance_tf_ae_history.png'))
else:
    plt.show()
...
plt.tight_layout()
if save_plots:
    plt.savefig(os.path.join('images', 'img_enhance_tf_ae_test.png'))
else:
    plt.show()
